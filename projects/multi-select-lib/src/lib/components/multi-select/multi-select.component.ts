...
export class MultiSelectComponent  {
  ...
  //           return child;
  //         });
  //         this.selectedArray = [...this.selectedChildren]
  //         console.log('children',this.selectedArray)
  //
  //       } else {
  ...
  //     });
  //   } else {
  //     this.selectedArray = this.selectedArray.filter((arr)=> arr.selected !== option.selected && arr.children)
  //   }
  //   this.selectedOption = this.selectedArray.map((el) => el.text).join(',');
  //   this.input?.patchValue(this.selectedOption);
  //   console.log('parent',this.selectedArray)
  // }
  //
  // onCheckChild(option: Option) {
  //   this.selectedArray = [...this.selectedArray,{...option}]
  //   console.log('child',this.selectedArray)
  // }
  //
  //
  //
